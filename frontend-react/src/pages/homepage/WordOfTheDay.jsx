...
const data = [
  ...
  },
  {
    ...
    type: "phrase",
    meaning:
      "Trâm anh thế phiệt — Wealth that has been inherited over several generations.",
    partOfSpeech: "noun",
    level: "C1",
    example:
      "She grew up surrounded by old money, attending elite schools and exclusive social events.",
    funFact:
      "The term contrasts with 'new money,' which refers to individuals who acquired wealth recently, often through business or entertainment.",
  },
];
